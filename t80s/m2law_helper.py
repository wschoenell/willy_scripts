...
load_file = 'm2controllaw_table6_064.fits' #None #'pointings_done.txt'  # 'lna_dome_model_data.txt'  # None
...
if load_file is not None:
    ...
    for point_load in load_model:
        ...
        for i in range(len(map_points)):
            ...
            if np.sqrt((point_load['ALT'] - map_point[0]) ** 2 + (point_load['AZ'] - map_point[1]) ** 2) < 4:
